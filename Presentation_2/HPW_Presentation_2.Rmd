...
* Sprogis et al. report: within high noise treatments, swim speed increased significantly by 33% from before to during vessel approaches (p = 0.007)
...
* Sprogis et al. report: within the high treatments, the respiration rate from before to during vessel approaches increased significantly by 42% (p = 0.001)
...
* Sprogis et al. report: within high noise treatments, the proportion of time resting from before to during vessel approaches decreased significantly (p = 0.02)
